...
import jieba
import os
from mybot.similarity import Similarity
from mybot.synonym import Synonym
from mybot.api_controller import APIcontroller
...
class MyBot:
    def __init__(self, filename, keys, name, sex, age, school, city, height, weight):
        ...
        self.synonym = Synonym("mybot/synonym.csv")   # 同义词库
            ...
            for sen in sentences:
                ...
                for item in self.info + self.database:
                    ...
                    if time.time() - start > 30:
                        return False
                    if Similarity.get_cos_similarity(sen, item[0]) > 0.8:
                        return item[1]
        return False
